...
将 Kiro Token 转换为标准的 Anthropic API 接口，可供 Claude Code、Cursor 等支持 Anthropic API 的客户端使用。
...
**使用方法：**
1. 在"转 API"页面配置监听端口和 API Key
2. 点击"启动服务"
3. 点击"一键配置 Claude Code"自动写入配置
4. 在 Claude Code 中即可使用
